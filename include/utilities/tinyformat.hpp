...
#pragma warning(pop)
	...
	template <long unsigned int n> struct is_wchar<const wchar_t[n]> {
	};
	template <long unsigned int n> struct is_wchar<wchar_t[n]> {
	};
...
namespace detail
{
	...
	inline const char *streamStateFromFormat(std::ostream &out, bool &positionalMode,
											 ...
											 const char *fmtStart, const detail::FormatArg *args,
	...
	//------------------------------------------------------------------------------
	inline void formatImpl(std::ostream &out, const char *fmt, const detail::FormatArg *args,
						   int numArgs)
	{
		// Saved stream state
		...
		while (true) {
			...
			int ntrunc = -1;
			const char *fmtEnd = streamStateFromFormat(out, positionalMode, spacePadPositive,
...
namespace detail
{
	...
	template <long unsigned int N> class FormatListN : public FormatList {
	public:
